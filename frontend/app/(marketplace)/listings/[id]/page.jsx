...
export default async function ListingDetailPage({ params }) {
  ...
  return (
    <div className="container py-6 lg:py-8">
      ...
      {status === 'sold' && (
        <div className="mb-5 rounded-lg border border-[#e4b3a6] bg-[#f7e6e0] px-4 py-3 text-sm font-medium text-[#8f3322]">
          This listing has been sold.
        </div>
      )}
      {status === 'paused' && (
        <div className="mb-5 rounded-lg border border-[#ecd6a0] bg-[#fbf1d6] px-4 py-3 text-sm font-medium text-[#8a5e12]">
        ...
        <div className="lg:sticky lg:top-20 lg:self-start">
          ...
          {seller && (
            <Link
              ...
              className="card mt-6 flex items-center gap-3 p-4 transition-colors hover:border-light_bronze-500"
            >
